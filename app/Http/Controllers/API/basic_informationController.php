...
class basic_informationController extends BaseController
{
...
return view('home');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'pincode.required' =>"Field Must not be empty",
            'pincode.integer' =>"Enter valid Post Code",
        ...
        $bInfo->pincode = $request->post_code;
